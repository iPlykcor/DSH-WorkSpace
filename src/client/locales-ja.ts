...
export const ja: Record<string, string> = {
  ...
  viewerWorkspace: 'マルチルートワークスペース',
  workspaceApply: 'このワークスペースを適用',
  workspaceApplied: 'サイドバーに適用済み',
  workspaceApplyFailed: '適用に失敗: {message}',
  workspaceDeactivate: 'マルチルートを終了',
  workspaceRoots: '{n} 個のルート',
  workspaceFolderReadOnly: '読み取り専用フォルダー（書き込み不可）',
  workspaceMissingFolder: 'ディレクトリなし',
  workspaceViolations: '読み取り専用への書き込み {n} 件',
  workspaceViolationsTitle: 'モデルが読み取り専用フォルダーに書き込んだ記録',
  workspaceViolationMeta: '{root} · {kind}',
  workspaceRollback: '復元',
  ...
  addPluginsBrowseMore: 'GitHub でプラグинをさらに閲覧（topic: dsh-workspace）',
  ...
  pluginSuhuangScrollDesc: 'ローカルの Suhuang Scroll Runtime を DSH 設定と better-sidebar に接続し、モデル設定、接続テスト、連続採点の操作を提供。Suhuang Scroll Runtime と dsh-workspace が必要',
