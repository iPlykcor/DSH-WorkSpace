...
export const tr: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'GitHub’da daha fazla eklentiye göz atın (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Yerel Suhuang Scroll Runtime ortamını model yapılandırması, bağlantı testi ve kesintisiz değerlendirme denetimi için DSH ayarlarına ve better-sidebar öğesine bağlar; Suhuang Scroll Runtime ve dsh-workspace gerektirir',
