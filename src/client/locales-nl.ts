...
export const nl: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Meer plugins bekijken op GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Verbindt de lokale Suhuang Scroll Runtime met DSH-instellingen en better-sidebar voor modelconfiguratie, verbindingstests en doorlopende beoordelingsbediening; vereist Suhuang Scroll Runtime en dsh-workspace',
