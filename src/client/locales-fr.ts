...
export const fr: Record<string, string> = {
  ...
  viewerHtml: 'HTML',
  viewerZip: 'Archive ZIP',
  viewerDocx: 'Document Word',
  viewerSpreadsheet: 'Tableur',
  viewerPresentation: 'Présentation',
  viewerVideo: 'Vidéo',
  browser: 'Navigateur',
  ...
  addPluginsBrowseMore: 'Parcourir plus de plugins sur GitHub (topic : dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Connecte le Runtime Suhuang Scroll local aux réglages DSH et à better-sidebar pour configurer le modèle, tester la connexion et contrôler la correction continue ; nécessite Suhuang Scroll Runtime et dsh-workspace',
