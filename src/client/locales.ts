...
export const zh = {
  ...
  // Multi-root workspace (.dsh-workspace)
  viewerWorkspace: '多根工作区',
  workspaceApply: '应用此工作区',
  workspaceApplied: '已应用到侧边栏',
  workspaceApplyFailed: '应用失败：{message}',
  workspaceDeactivate: '退出多根工作区',
  ...
  workspaceInvalidManifest: '不是有效的 .dsh-workspace 清单',
  workspaceAutoApplyOn: '打开文件即自动应用',
  workspaceAutoApplyOff: '不会自动应用（请点“应用”）',
  collapseAll: '折叠全部',
  centerFileEmpty: '在侧边栏打开一个文件，它会显示在这里',
  centerFileBinary: '该类型文件暂不支持在中间预览（可下载查看）',
  ...
  viewerVideo: '视频',
  viewerDocx: 'Word 文档',
  viewerSpreadsheet: 'Excel 表格',
  viewerPresentation: 'PPT 幻灯片',
  viewerHtml: 'HTML',
  browser: '浏览器',
  ...
  addPluginsBrowseMore: '在 GitHub 上浏览更多插件（topic: dsh-workspace）',
  ...
  pluginSuhuangScrollDesc: '把本地苏黄共阅 Runtime 接入 DSH 设置与 better-sidebar，支持模型配置、连接测试和连续阅卷控制；使用前需安装 Suhuang Scroll Runtime 与 dsh-workspace',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  addPluginsBrowseMore: 'Browse more plugins on GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Connect the local Suhuang Scroll Runtime to DSH settings and better-sidebar for model configuration, connection tests, and continuous grading controls; requires Suhuang Scroll Runtime and dsh-workspace',
