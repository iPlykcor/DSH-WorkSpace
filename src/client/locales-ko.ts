...
export const ko: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'GitHub에서 더 많은 플러그인 보기(topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: '로컬 Suhuang Scroll Runtime을 DSH 설정과 better-sidebar에 연결하여 모델 구성, 연결 테스트, 연속 채점 제어를 제공합니다. Suhuang Scroll Runtime과 dsh-workspace가 필요합니다',
