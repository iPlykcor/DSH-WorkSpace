...
export const ar: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'تصفّح المزيد من الإضافات على GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'يربط بيئة Suhuang Scroll المحلية بإعدادات DSH وbetter-sidebar لإعداد النموذج واختبار الاتصال والتحكم في التصحيح المتواصل؛ يتطلب Suhuang Scroll Runtime وdsh-workspace',
