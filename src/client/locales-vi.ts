...
export const vi: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Duyệt thêm plugin trên GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Kết nối Suhuang Scroll Runtime cục bộ với phần cài đặt DSH và better-sidebar để cấu hình mô hình, kiểm tra kết nối và điều khiển chấm bài liên tục; yêu cầu Suhuang Scroll Runtime và dsh-workspace',
