...
export const pl: Record<string, string> = {
  ...
  viewerHtml: 'HTML',
  viewerZip: 'Archiwum ZIP',
  viewerDocx: 'Dokument Word',
  viewerSpreadsheet: 'Arkusz kalkulacyjny',
  viewerPresentation: 'Prezentacja',
  viewerVideo: 'Wideo',
  ...
  addPluginsBrowseMore: 'Przeglądaj więcej wtyczek na GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Łączy lokalny Suhuang Scroll Runtime z ustawieniami DSH i better-sidebar, zapewniając konfigurację modelu, test połączenia i sterowanie ciągłym ocenianiem; wymaga Suhuang Scroll Runtime i dsh-workspace',
