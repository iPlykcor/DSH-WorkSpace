export const sv: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Bläddra bland fler plugins på GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Ansluter den lokala Suhuang Scroll Runtime till DSH-inställningar och better-sidebar för modellkonfiguration, anslutningstest och styrning av kontinuerlig rättning; kräver Suhuang Scroll Runtime och dsh-workspace',
