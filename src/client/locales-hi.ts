...
export const hi: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'GitHub पर और प्लगइन्स देखें (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'स्थानीय Suhuang Scroll Runtime को DSH सेटिंग्स और better-sidebar से जोड़ता है, ताकि मॉडल कॉन्फ़िगरेशन, कनेक्शन परीक्षण और निरंतर ग्रेडिंग नियंत्रण उपलब्ध हों; Suhuang Scroll Runtime और dsh-workspace आवश्यक हैं',
