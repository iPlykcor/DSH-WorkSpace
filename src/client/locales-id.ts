...
export const id: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Jelajahi lebih banyak plugin di GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Menghubungkan Suhuang Scroll Runtime lokal ke pengaturan DSH dan better-sidebar untuk konfigurasi model, uji koneksi, dan kontrol penilaian berkelanjutan; memerlukan Suhuang Scroll Runtime dan dsh-workspace',
