 ...
 *
 * @module dsh-workspace/client/locales-it
 */
...
export const it: Record<string, string> = {
  ...
  viewerHtml: 'HTML',
  viewerZip: 'Archivio ZIP',
  viewerDocx: 'Documento Word',
  viewerSpreadsheet: 'Foglio di calcolo',
  viewerPresentation: 'Presentazione',
  viewerVideo: 'Video',
  browser: 'Browser',
  ...
  addPluginsBrowseMore: 'Sfogli altri plugin su GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Collega il Runtime Suhuang Scroll locale alle impostazioni DSH e a better-sidebar per configurare il modello, testare la connessione e controllare la correzione continua; richiede Suhuang Scroll Runtime e dsh-workspace',
