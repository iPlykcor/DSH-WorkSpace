...
export const ru: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Найти больше плагинов на GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Подключает локальный Suhuang Scroll Runtime к настройкам DSH и better-sidebar для настройки модели, проверки соединения и управления непрерывной проверкой; требуются Suhuang Scroll Runtime и dsh-workspace',
