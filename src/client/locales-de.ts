...
export const de: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Weitere Plugins auf GitHub durchsuchen (Topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Verbindet die lokale Suhuang Scroll Runtime mit den DSH-Einstellungen und better-sidebar für Modellkonfiguration, Verbindungstests und fortlaufende Bewertung; benötigt Suhuang Scroll Runtime und dsh-workspace',
