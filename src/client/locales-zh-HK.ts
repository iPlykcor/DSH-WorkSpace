...
export const zhHK: Record<string, string> = {
  ...
  addPluginsBrowseMore: '在 GitHub 上瀏覽更多插件（topic: dsh-workspace）',
  ...
  pluginSuhuangScrollDesc: '把本機蘇黃共閱 Runtime 接入 DSH 設定與 better-sidebar，支援模型設定、連線測試及連續閱卷控制；使用前須安裝 Suhuang Scroll Runtime 與 dsh-workspace',
  ...
  centerFileEmpty: '\u5728\u5074\u908a\u6b04\u6253\u958b\u4e00\u500b\u6587\u4ef6\uff0c\u5b83\u6703\u986f\u793a\u5728\u9019\u88e1',
  centerFileBinary: '\u8a72\u985e\u578b\u6587\u4ef6\u66ab\u4e0d\u652f\u63f4\u5728\u4e2d\u5fc3\u9810\u89bd\uff08\u53ef\u4e0b\u8f09\u67e5\u770b\uff09',
}