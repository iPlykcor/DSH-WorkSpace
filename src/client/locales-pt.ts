export const pt: Record<string, string> = {
  ...
  addPluginsBrowseMore: 'Navegue por mais plugins no GitHub (topic: dsh-workspace)',
  ...
  pluginSuhuangScrollDesc: 'Conecta o Suhuang Scroll Runtime local às configurações do DSH e ao better-sidebar para configurar o modelo, testar a conexão e controlar a correção contínua; requer Suhuang Scroll Runtime e dsh-workspace',
